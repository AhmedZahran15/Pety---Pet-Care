...
const HeroSection = () => {
  return (
    <div className="flex h-[105dvh] items-center justify-center overflow-hidden bg-[url('/images/homepage/herobackground.png')] bg-cover bg-center  bg-no-repeat transition-all duration-300 md:justify-between  md:bg-bottom  ">
      <img
        className="hidden w-[37dvw] md:mt-[-35px] md:block transition-all duration-300"
