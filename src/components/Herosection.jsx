...
const HeroSection = () => {
  return (
    <div className="flex h-[105dvh] items-center justify-center overflow-hidden duration-300 md:justify-between  md:bg-bottom  ">
      <img
        className="ml-20 hidden w-[37dvw] transition-all duration-300 md:mt-[-35px]  md:block "
        src="images/homepage/eric-ward-ISg37AI2A-s-unsplash 1.png"
        alt="cat"
      />

      <div className="flex h-full flex-col gap-9 px-12 py-28  transition-all duration-300 md:gap-5 lg:px-28 xl:pt-40">
        ...
        <Link
          className="font-['Roboto Flex'] w-[13rem] rounded-3xl bg-secondary  px-4 py-1.5 text-center font-['Montserrat'] text-2xl font-bold text-white transition-all duration-300  hover:bg-amber-400 "
          to="/about"
        >
          Learn More
        </Link>
