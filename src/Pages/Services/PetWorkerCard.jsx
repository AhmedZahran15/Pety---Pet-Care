...
function PetWorkerCard({ data }) {
  ...
  const animals = data.animals
    ...
    .join("");
  return (
    <div className="flex w-full min-w-[410px] cursor-pointer flex-col items-center justify-center gap-x-8 gap-y-6 rounded-xl border-[0.5px] border-black border-opacity-20 bg-white py-4 pl-2 pr-10 shadow-lg shadow-neutral-300 hover:bg-neutral-50 xl:flex-row xl:py-12">
