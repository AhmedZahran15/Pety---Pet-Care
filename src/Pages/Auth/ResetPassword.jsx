  ...
  return (
    <div className="z-10 flex w-full flex-col gap-6 overflow-y-auto rounded-3xl bg-white px-6 py-6 shadow-md shadow-neutral-400 transition-all duration-300 no-scrollbar sm:px-10 md:w-8/12 lg:p-16 lg:pr-36 xl:pr-64">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <button
          type="submit"
          className="w-full max-w-sm self-center rounded-lg bg-primary p-3 font-semibold text-white transition-all duration-300 hover:bg-[#015d61] focus:outline-none focus:ring-2 focus:ring-primary"
        >
          {isLoading ? (
